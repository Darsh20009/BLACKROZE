...
//  │                                                                                             │
//  │  This file controls EVERY branding detail across the entire BLACKROSE system:                  │
...
export const brand = {
  ...
  descriptionEn: "Enjoy the finest coffee crafted with care. Order now from Blackrose Cafe for an exceptional coffee experience.",

  /** Arabic marketing description */
  descriptionAr: "استمتع بأفضل قهوة محضرة بعناية فائقة من بلاك روز كافيه - اطلب الآن واستمتع بتجربة قهوة استثنائية",

  /** Keywords for SEO meta tag */
  keywords: "قهوة, Blackrose Cafe, coffee, cafe, كافيه, اسبريسو, لاتيه, كابتشينو, موكا, قهوة سعودية, طلب قهوة, توصيل قهوة",
  ...
  logoAssetCustomer: "blackrose-logo-customer.png",

  /** Staff logo asset path */
  logoAssetStaff: "blackrose-logo-staff.png",

  /** Logo URL for email templates (must be absolute/public URL) */
  logoEmailUrl: "https://raw.githubusercontent.com/Darsh20009/BLACKROSEsystem/main/client/public/logo.png",
  ...
  website: "blackrosestudio.online",
  websiteUrl: "https://www.blackrosestudio.online",

  emailNoReply: "noreply@blackrosestudio.online",
  emailSupport: "support@blackrosestudio.online",
  ...
  pointsBrandEn: "BLACKROSE Points",
  pointsBrandAr: "نقاط بلاك روز",

  cardBrandEn: "BLACKROSE Card",
  cardBrandAr: "بطاقة بلاك روز",

  loyaltyTaglineEn: "Blackrose Cafe Loyalty",
  ...
  aiAssistantNameEn: "BLACKROSE AI Assistant",
  ...
  copyrightEn: `© ${new Date().getFullYear()} BLACKROSE Systems. All rights reserved.`,
