...
const OrdersDisplayEnhanced = lazy(() => import("@/pages/orders-display-enhanced"));
...
const BootstrapAdmin = lazy(() => import("@/pages/bootstrap-admin"));
...
const PageLoader = () => {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center bg-[#F7F8F8]">
