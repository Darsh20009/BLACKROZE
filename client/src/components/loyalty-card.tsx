...
export default function LoyaltyCardComponent({ card, showActions = true, compact = false, showTierProgress = true }: LoyaltyCardProps) {
  ...
  useEffect(() => {
    if (qrCanvasRef.current && card.qrToken) {
      ...
      const cardUrl = `https://www.blackrose.com.sa/loyalty-verify?token=${card.qrToken}`;
      QRCode.toCanvas(
        qrCanvasRef.current,
        cardUrl,
        {
        ...
        <div className="relative p-6 space-y-5">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-2xl font-bold" data-testid="text-brand">BLACK ROSE CAFE</h3>
      ...
      {showActions && (
        <div className="grid grid-cols-2 gap-3">
          ...
          <Button
            ...
            onClick={() => {
              const url = `https://www.blackrose.com.sa/api/loyalty/cards/${card.id}/apple-wallet-pass`;
