...
if (typeof document !== 'undefined') {
  document.title = "شاشة المطبخ - BLACK ROSE CAFE | إدارة الطلبات";
  const metaDesc = document.querySelector('meta[name="description"]');
  if (metaDesc) metaDesc.setAttribute('content', 'شاشة المطبخ لـ BLACK ROSE CAFE - إدارة سهلة وسريعة للطلبات المدخلة');
}
