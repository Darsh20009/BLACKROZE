...
export default function ResetPassword() {
 ...
 // Set SEO metadata
 useEffect(() => {
   document.title = "إعادة تعيين كلمة المرور - BLACK ROSE CAFE";
   const metaDesc = document.querySelector('meta[name="description"]');
   if (metaDesc) metaDesc.setAttribute('content', 'إعادة تعيين كلمة المرور على BLACK ROSE CAFE - أدخل كلمة مرور جديدة آمنة');
 }, []);
