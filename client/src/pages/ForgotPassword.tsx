...
export default function ForgotPassword() {
 ...
 // Set SEO metadata
 useEffect(() => {
   document.title = "نسيت كلمة المرور - BLACK ROSE CAFE | إعادة تعيين";
   const metaDesc = document.querySelector('meta[name="description"]');
   if (metaDesc) metaDesc.setAttribute('content', 'نسيت كلمة المرور؟ أعد تعيين كلمة مرورك على BLACK ROSE CAFE بسهولة');
 }, []);
