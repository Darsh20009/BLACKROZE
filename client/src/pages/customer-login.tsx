...
export default function CustomerLogin() {
 ...
 const [mode, setMode] = useState<'choice' | 'register' | 'guest'>('choice');
  ...
  // Set SEO metadata
  useEffect(() => {
    document.title = "تسجيل دخول العملاء - BLACK ROSE | ادخل الآن";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', 'تسجيل دخول عملاء BLACK ROSE - سجل الآن واستمتع بعروضنا الحصرية والمكافآت');
  }, []);
 ...
 <h1 className="text-4xl font-bold font-playfair text-foreground">BLACK ROSE</h1>
 </div>
