            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-xl font-bold text-amber-400">{data.totals.totalBaseSalary.toLocaleString()} ر.س</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-xl font-bold text-red-400">{data.totals.totalDeductions.toLocaleString()} ر.س</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-xl font-bold text-green-400">{data.totals.totalNetSalary.toLocaleString()} ر.س</p>
                </CardContent>
              </Card>
            </div>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between mb-3 flex-wrap gap-2">
                        ...
                        <div className="text-right">
                          <p className="text-green-400 font-bold text-lg">{emp.netSalary.toLocaleString()} ر.س</p>
                      ...
                      {(emp.deductions > 0 || emp.lateDeductions > 0) && (
                        <div className="flex items-center gap-2 text-xs text-red-400 bg-red-900/20 rounded-lg p-2 mt-2">
                          ...
                          <span>خصم غياب: {emp.deductions} ر.س | خصم تأخير: {emp.lateDeductions} ر.س</span>
                        </div>
                      )}
                    </CardContent>
                  </Card>
