          ...
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="bg-slate-900 border-slate-700 text-white" dir="rtl">
              ...
              <div className="space-y-4">
                <div>
                  <Label className="text-slate-300">قيمة البطاقة (ر.س) *</Label>
                  <Input
                    type="number" min="1"
                    value={form.value}
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-2">
                          <span className="text-slate-400 text-xs">القيمة: <span className="text-white font-medium">{card.initialValue} ر.س</span></span>
                          <span className="text-slate-400 text-xs">المتبقي: <span className="text-green-400 font-medium">{card.balance} ر.س</span></span>
                        </div>
