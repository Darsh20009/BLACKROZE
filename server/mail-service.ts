...
export async function sendOrderNotificationEmail(
  ...
  try {
    ...
    const senderEmail = process.env.SMTP_FROM || "cluny.support@cluny.shop";
...
export async function sendReferralEmail(
  ...
  try {
    await transporter.sendMail({
      from: `"CLUNY CAFE" <cluny.support@cluny.shop>`,
      to: customerEmail,
...
export async function sendReservationConfirmationEmail(
  ...
  try {
    const senderEmail = process.env.SMTP_FROM || "CLUNY CAFE <cluny.support@cluny.shop>";
