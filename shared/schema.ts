...
const TaxInvoiceSchema = new Schema<ITaxInvoice>({
  ...
  sellerAddress: { type: String, required: true, default: 'ينبع، حي البندر، الملك خالد ابن عبدالعزيز سعود 4139، المملكة العربية السعودية' },
  sellerCity: { type: String, default: 'ينبع' },
